...
<body>
	 ...
	 <div class="container-fluid wrapper">
		...
		<div class="row">
				...
				<div class="col-lg-12">
					<div class="menu-container">
						<div class="menu">
							<?php wp_nav_menu( array( 'theme_location' => 'menu_poziome', 'depth' => 2)); ?>
						</div>
					</div>
		...
		<div class="row">
	 	...
	 	<div  class="row">
			<div id="sidebar" class="col-sm-2  col-sm-offset-1  ">
				<nav class="sidemenu">
					<?php wp_nav_menu( array( 'theme_location' => 'menu_pionowe', 'depth' => 2)); ?>
				</nav>
			</div>
